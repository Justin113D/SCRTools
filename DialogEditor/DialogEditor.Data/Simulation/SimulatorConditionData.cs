...
{
    public class SimulatorConditionData : IDataAccess, IDataSetter
    {
        ...
        private ConditionData _baseData;
        ...
        internal SimulatorConditionData(ConditionData data)
        {
            _baseData = data.Clone();
            Data = data.Clone();
            LocalNumbers = new();
            LocalBooleans = new();
        }
        ...
        public void ReplaceData(ConditionData data)
        {
            BeginChangeGroup();
            TrackValueChange((v) => Data = v, Data, data.Clone());
            TrackValueChange((v) => _baseData = v, _baseData, data.Clone());
            EndChangeGroup();
        }
        ...
        {
            BeginChangeGroup();
            TrackValueChange((v) => Data = v, Data, _baseData.Clone());
            LocalNumbers.Clear();
            LocalBooleans.Clear();
            EndChangeGroup();
        }
