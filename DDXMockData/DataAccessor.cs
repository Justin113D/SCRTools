...
namespace SCR.Tools.DynamicDataExpression.Mockdata
{
    public sealed class MockSCRDataAccessor : IDataAccess<MockSCRData>
    {
        public static readonly MockSCRDataAccessor DA = new();

        public ReadOnlyDictionary<string, DataKey<MockSCRData>> DataKeys { get; }

        private MockSCRDataAccessor()
        {
